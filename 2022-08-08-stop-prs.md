...
coverImageUrl: https://github.com/alvarolorentedev/diagrams/blob/main/Stop%20doing%20PR.drawio.png?raw=true
publishedAt: '2022-08-08'
originalArticleURL: https://www.alvarolorente.dev/blog/2022/08/08/stop-prs
ogTitle: Stop doing PR's inside the Office
ogDescription: PRs should only be part of certain environments and not a general practice
ogImage: https://github.com/alvarolorentedev/diagrams/blob/main/Stop%20doing%20PR.drawio.png?raw=true
tags:
- name: agile
  slug: agile
- name: webdev
